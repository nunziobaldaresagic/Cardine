...
export default function LoginPage() {
  ...
  // Flusso mock per Career Counselor
  async function handleCounselorLogin() {
    setLoading('counselor');
    setError(null);
    try {
      const res = await login('counselor');
      ...
      <div className={styles.mobile}>
        ...
        <div className={styles.mobileWrap}>
          <div className={styles.glassCard}>
            ...
            <p className={styles.mobileSubtitle}>Accedi per esplorare le tue opportunità di crescita professionale.</p>
            ...
            <div className={styles.mobileSecurityBox}>
              ...
              <div>
                ...
                <p className={styles.securityText}>
                  Utilizziamo il Single Sign-On (SSO) tramite il tuo account aziendale per garantire la massima
            ...
            <div className={styles.loginPanel}>
              <div className={styles.desktopLogoGroup}>
                ...
                <p className={styles.desktopSubtitle}>
                  Accedi alla piattaforma per gestire la tua crescita professionale e scoprire nuove opportunità
                  interne.
                </p>
              </div>
              ...
              <div className={styles.desktopActions}>
                ...
                <button
                  type='button'
                  className={`${styles.ctaBtn} ${styles.ctaBtnDesktop}`}
                ...
                <div className={styles.desktopSecurityBox}>
                  ...
                  <p className={`${styles.securityText} ${styles.securityTextIndent}`}>
                    Cardine utilizza l'infrastruttura Microsoft Entra ID della tua azienda. I tuoi dati personali, le
                    credenziali e le informazioni sulla carriera sono crittografati e gestiti in conformità con le
                    policy di sicurezza aziendali. Nessuna password aggiuntiva è richiesta o memorizzata da Cardine.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={styles.brandPanel} aria-hidden='true'>
              ...
              <div className={styles.brandContent}>
                ...
                <p className={styles.brandText}>
                  Mappa le tue competenze, esplora percorsi di carriera interni e trova il tuo prossimo ruolo ideale
