...
# Add parent directory to path for ooxml imports
...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "Agic", initials: str = "A"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "Agic")
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "Agic")
